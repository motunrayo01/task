            ...
            <div>
                <div className="container-fluid">
                   <div className="row">
                       ...
                       <div className="col-6 demands" >
                           <img src= "https://res.cloudinary.com/morayo/image/upload/v1608324720/man-using-ipad-xlarge_pcldso.webp" alt="a man"/>
                       </div>
                       </div> 
                </div>
            </div>
